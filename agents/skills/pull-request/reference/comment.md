...
For end-to-end “retrieve PR → review → reconcile drafts → publish”, stop and use the **`code-review` skill `publish`** execution instead. The `comment` branch is for findings the user or another workflow already verified.
