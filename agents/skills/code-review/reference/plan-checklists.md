...
Checklists for **`$dev` `plan`** — not a findings report. Post-implement: full **`code-review` findings**. SoT: [`dev/reference/plan-pipeline.md`](../../dev/reference/plan-pipeline.md).
